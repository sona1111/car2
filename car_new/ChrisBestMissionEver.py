        ...
        while self.exitFlag == False: #and cycles < 100000 
            ...
            if self.hold == True:
                ...
                if(whereToGo == 'forwards'):
                    ...
                    #if(self.map.getCombined()[self.map.carPos][self.map.carPos-1] == 1):  #or 
                    #self.map.getCombined()[self.map.carPos][self.map.carPos-2] == 1  or 
                    #self.map.getCombined()[self.map.carPos][self.map.carPos-3] == 1 or 
                    #self.map.getCombined()[self.map.carPos][self.map.carPos-4] == 1): 
